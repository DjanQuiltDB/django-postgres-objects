...
ordering — pgtrigger patching after this package — is the one that fails if this package writes only the command
attribute and leaves the module-level names behind.
"""
